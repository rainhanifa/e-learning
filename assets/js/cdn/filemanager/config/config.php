...
//    |   |   |   |   |- plugin.min.js
$base_url = 'http://'.$_SERVER['HTTP_HOST'].'/e_pko/';  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = 'http://'.$_SERVER['HTTP_HOST'].'/e_pko/public/js/cdn/source/'; // path from base_url to base of upload folder (with start and final /)
